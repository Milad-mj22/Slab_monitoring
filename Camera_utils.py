...
class Camera_6:
    ...
    def stream(self):
        import camera
        self.collector = camera.Collector(exposure=100000 , gain=0)
        # print('milad',self.collector.cameras)
        ...
        def streaming():
            ...
            while self.ret:
                ...
                np_image,hjghj = self.collector.getPictures()
                np_image=np_image['23911196']
                # print('asd')
                self.ret=True
               # print(np_image)
                if np_image is None:
