...
#ui2, _ = loadUiType("splash_screen.ui")
...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        image='G:\work\PySide-Responsive-ui-master\images\dorsa2.png'
        self.label_title.setPixmap(QPixmap.fromImage(image))
        SplashScreen.setWindowTitle(QCoreApplication.translate("SplashScreen", u"MainWindow", None))
       # self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>DORSA</strong>  ", None))
        self.label_description.setText(QCoreApplication.translate("SplashScreen", u"<strong>APP</strong> SLAB Monitoring System", None))
        self.label_loading.setText(QCoreApplication.translate("SplashScreen", u"loading...", None))
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>Created</strong>: DORSA group", None))
    # retranslateUi
